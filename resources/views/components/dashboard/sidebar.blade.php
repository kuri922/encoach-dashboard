<div class="container ml-3">
    ...
    <div class="d-flex flex-column">
        <label class="encoach-sidebar-category-label">受注一覧</label>
    </div>
    ...
    <label class="encoach-sidebar-category-label">CSV一括登録</label>
    </div>
    ...
    <h2>その他</h2>
    <div class="d-flex flex-column">
        <label class="encoach-sidebar-category-label">新着情報管理</label>
        <label class="encoach-sidebar-category-label">管理ユーザー管理</label>
    </div>
</div>